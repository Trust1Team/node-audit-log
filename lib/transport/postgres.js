...
PostgresTransport = function(options) {
    ...
    function initCreate(cb){
        execQuery('CREATE TABLE IF NOT EXISTS '+tableName+' (actor VARCHAR(255) NOT NULL, ts TIMESTAMP WITHOUT TIME ZONE NOT NULL, origin VARCHAR(255) NULL, action VARCHAR(255) NULL, label VARCHAR(255) NULL, object VARCHAR(255) NULL, description VARCHAR(255) NULL);');
